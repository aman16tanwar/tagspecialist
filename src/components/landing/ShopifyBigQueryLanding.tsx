                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                            ...
                            <Link
                                ...
                                className="px-8 py-4 bg-white/10 text-white font-semibold rounded-sm border border-white/20 hover:bg-white/20 shadow-lg transform transition-all duration-200 hover:scale-105 uppercase text-sm tracking-wide"
                            >
                                DIY Tutorial →
                            </Link>
                        </div>
            ...
            <section className="py-8 bg-orange-50 border-y border-orange-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-start gap-4">
                        <HiExclamation className="w-6 h-6 text-orange-600 flex-shrink-0 mt-1" />
                        <div>
                            ...
                            <p className="text-gray-700">
                                ...
                                <span className="text-navy-900 font-semibold"> We give you unlimited rows from day one.</span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {features.map((feature, idx) => (
                            <motion.div
                                ...
                                className="bg-gray-50 rounded-lg p-6 border border-gray-200 hover:border-blue-600 transition-all"
                            >
