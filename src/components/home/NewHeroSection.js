      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          >
             ...
             <button 
               onClick={() => {
                 const event = new CustomEvent('openContactForm', { detail: { service: 'Analytics & Tracking' } });
          ...
          >
             ...
             <button 
               onClick={() => {
                 const event = new CustomEvent('openContactForm', { detail: { service: 'Data Engineering' } });
                 window.dispatchEvent(event);
               }}
