        ...
        <div className="min-h-screen bg-white pt-20">
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <h2 className="text-3xl font-bold text-navy-900 mb-6 text-center">See It In Action</h2>
                        <div className="relative bg-gray-100 rounded-xl overflow-hidden aspect-video mb-8 group cursor-pointer border border-gray-200 hover:border-blue-500 transition-all">
                            <div className="absolute inset-0 flex items-center justify-center bg-gray-900/10 group-hover:bg-gray-900/20 transition-all">
                                <div className="text-center">
                                    <div className="w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform shadow-lg">
                                        <HiPlay className="w-10 h-10 text-white ml-1" />
                                    </div>
                                    <p className="text-white text-lg font-medium drop-shadow-md">Watch 2-minute Demo</p>
                                    <p className="text-white text-sm mt-1 drop-shadow-md">See how easy it is to onboard a new store</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                            <div className="bg-gray-50 rounded-lg p-4 text-center border border-gray-200">
                                <HiDesktopComputer className="w-8 h-8 text-blue-600 mx-auto mb-2" />
                                <h3 className="font-semibold text-navy-900 mb-1">Web Interface</h3>
                                <p className="text-sm text-gray-600">Simple form-based setup</p>
                            </div>
                            <div className="bg-gray-50 rounded-lg p-4 text-center border border-gray-200">
                                <HiCloud className="w-8 h-8 text-green-600 mx-auto mb-2" />
                                <h3 className="font-semibold text-navy-900 mb-1">Auto Deploy</h3>
                                <p className="text-sm text-gray-600">Cloud Build handles everything</p>
                            </div>
                            <div className="bg-gray-50 rounded-lg p-4 text-center border border-gray-200">
                                <HiChartBar className="w-8 h-8 text-purple-600 mx-auto mb-2" />
                                <h3 className="font-semibold text-navy-900 mb-1">Instant Data</h3>
                                <p className="text-sm text-gray-600">See results in BigQuery immediately</p>
                            </div>
                        </div>
                    </motion.div>
                </div>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-navy-900 mb-8">The Journey: From Manual to Magical</h2>
                        ...
                        <div className="bg-white rounded-lg p-6 mb-8 border border-gray-200 shadow-sm">
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span className="text-gray-600 italic">"Love the solution, but I'm not technical enough to deploy it"</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="text-yellow-500">💬</span>
                                    <span className="text-gray-600 italic">"Can you just set this up for me? Happy to pay for the service"</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="text-yellow-500">🤔</span>
                                    <span className="text-gray-600 italic">"Docker and Cloud Run are intimidating for non-developers"</span>
                                </li>
                            </ul>
                        </div>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-3xl font-bold text-navy-900 mb-8 text-center">DIY vs Automated: Side-by-Side</h2>
                    
                    <div className="overflow-x-auto rounded-lg border border-gray-200 shadow-sm">
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-200 bg-gray-50">
                                    <th className="text-left py-4 px-4 text-navy-900 font-semibold">Feature</th>
                                    <th className="text-left py-4 px-4 text-navy-900 font-semibold">DIY Solution</th>
                                    <th className="text-left py-4 px-4 text-navy-900 font-semibold">Automated Solution</th>
                                    <th className="text-left py-4 px-4 text-green-600 font-semibold">Improvement</th>
                                </tr>
                            </thead>
                            <tbody>
                                {comparisonData.map((row, idx) => (
                                    <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                        <td className="py-4 px-4 text-navy-900 font-medium">{row.feature}</td>
                                        <td className="py-4 px-4 text-gray-600">{row.diy}</td>
                                        <td className="py-4 px-4 text-blue-600 font-medium">{row.automated}</td>
                                        <td className="py-4 px-4 text-green-600 font-medium">{row.savings}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-navy-900 mb-12 text-center">How the Automated System Works</h2>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-navy-900">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="overflow-x-auto mb-12 rounded-lg border border-white/10">
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-white/10 bg-white/5">
                                    <th className="text-left py-4 px-4 text-gray-300 font-medium">Solution</th>
                                    <th className="text-left py-4 px-4 text-gray-300 font-medium">Row Limit</th>
                                    <th className="text-left py-4 px-4 text-gray-300 font-medium">Starting Price</th>
                                    <th className="text-left py-4 px-4 text-gray-300 font-medium">Reality Check</th>
                                    <th className="text-left py-4 px-4 text-gray-300 font-medium">After Limits</th>
                                </tr>
                            </thead>
                            <tbody>
                                {pricingComparison.map((row, idx) => (
                                    <tr key={idx} className={`border-b border-white/10 ${row.tool.includes('Our') ? 'bg-blue-900/30' : ''}`}>
                                        <td className="py-4 px-4 text-white font-medium">{row.tool}</td>
                                        <td className="py-4 px-4 text-gray-400">{row.stores}</td>
                                        <td className="py-4 px-4 text-gray-400">{row.cost}</td>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-navy-900 mb-8">How We Make Money (Transparently)</h2>
                    
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                            <h3 className="text-xl font-semibold text-navy-900 mb-4">Free Forever</h3>
                            <ul className="space-y-3">
                                <li className="flex items-center gap-2">
                                    <HiCheckCircle className="w-5 h-5 text-green-600" />
                                    <span className="text-gray-600">Up to 3 Shopify stores</span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <HiCheckCircle className="w-5 h-5 text-green-600" />
                                    <span className="text-gray-600">Full pipeline functionality</span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <HiCheckCircle className="w-5 h-5 text-green-600" />
                        ...
                        <div className="bg-blue-50 rounded-lg p-6 border border-blue-100">
                            <h3 className="text-xl font-semibold text-navy-900 mb-4">Premium Add-ons</h3>
                            <ul className="space-y-3">
                                <li className="flex items-start gap-2">
                                    <HiCurrencyDollar className="w-5 h-5 text-yellow-600 mt-0.5" />
                                    <div>
                                        <span className="text-navy-900 font-medium">Additional stores</span>
                                        <span className="text-gray-600 text-sm block">$47/store/month after 3 stores</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-2">
                                    <HiCurrencyDollar className="w-5 h-5 text-yellow-600 mt-0.5" />
                                    <div>
                                        <span className="text-navy-900 font-medium">Priority support</span>
                                        <span className="text-gray-600 text-sm block">$197/month - 24hr response time</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-2">
                                    <HiCurrencyDollar className="w-5 h-5 text-yellow-600 mt-0.5" />
                                    <div>
                                        <span className="text-navy-900 font-medium">Custom integrations</span>
                                        <span className="text-gray-600 text-sm block">Starting at $2,500</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-navy-900 mb-8">Under the Hood: Technical Architecture</h2>
                    ...
                    <div className="bg-navy-900 rounded-lg p-6 mb-8 border border-gray-700">
    ...
    └── shopify-token-clientN`}</code>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                            <h4 className="text-lg font-semibold text-navy-900 mb-3">Cost Optimizations</h4>
                        ...
                        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                            <h4 className="text-lg font-semibold text-navy-900 mb-3">Security Features</h4>
                            <ul className="space-y-2 text-sm text-gray-600">
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-navy-900 mb-8 text-center">Early Adopter Success</h2>
                    
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 shadow-sm">
                            <div className="flex items-center gap-2 mb-4">
                                <HiUserGroup className="w-6 h-6 text-blue-600" />
                                <h3 className="text-lg font-semibold text-navy-900">Fashion Retailer</h3>
                            </div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 shadow-sm">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-lg font-semibold text-navy-900">Multi-Brand Agency</h3>
                            </div>
                            <p className="text-gray-600 mb-4">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-navy-900">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <div className="bg-white/10 rounded-2xl p-8 border border-white/20 max-w-md mx-auto mb-8">
                            <div className="mb-6">
                            ...
                            <a
                                ...
                                className="block w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-lg hover:shadow-lg transform transition-all duration-200 hover:scale-105 uppercase text-sm tracking-wide"
                            >
                                Start Free Now
            ...
            {/* Final Note */}
            <section className="py-12 px-4 sm:px-6 lg:px-8 border-t border-gray-200 bg-white">
                <div className="max-w-4xl mx-auto text-center">
                    <p className="text-gray-600">
                        Still prefer the DIY approach? The{' '}
                        <Link to="/blog/shopify-bigquery-pipeline-tutorial" className="text-blue-600 hover:text-blue-800">
                            original tutorial
                        </Link>
                        {' '}and{' '}
                        <Link to="/starter-package" className="text-blue-600 hover:text-blue-800">
                            source code package
                        </Link>
                        {' '}are still available.
                    </p>
