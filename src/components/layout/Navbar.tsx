                      ...
                      <div className="bg-navy-900 rounded-3xl p-6 text-white h-full flex flex-col">
                        ...
                        <button
                          onClick={() => {
                            ...
                            openContactForm({ service: 'Free Audit' });
                          }}
              ...
              <div className="p-6 space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    <Link href="/services#tracking-audit" onClick={() => setIsMobileMenuOpen(false)} className="block p-4 bg-green-50 rounded-2xl font-black text-xs uppercase tracking-tight text-green-700">Tracking Audit ($3.5k)</Link>
