      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="bg-gray-800 rounded-2xl p-8 md:p-12 border border-gray-700">
          <div className="flex items-center mb-6">
            <HiDocumentText className="w-12 h-12 text-blue-500 mr-4" />
            <div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-4">Tag Specialist provides the following professional services:</p>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 space-y-3">
                <p className="text-gray-300">
                  <strong>Pricing:</strong> All prices are in USD unless otherwise specified. Prices are subject 
                  to change with 30 days notice.
                </p>
                <p className="text-gray-300">
                  <strong>Payment Schedule:</strong> 50% deposit upon project initiation, 50% upon completion, 
                  unless otherwise agreed in writing.
                </p>
                <p className="text-gray-300">
                  <strong>Late Payments:</strong> Payments more than 30 days overdue may incur a 1.5% monthly 
                  interest charge.
                </p>
                <p className="text-gray-300">
                  <strong>Refunds:</strong> Refunds are handled on a case-by-case basis. See our Refund Policy 
                  for details.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-4">
                <strong>Client Data:</strong> You retain all rights to your data. We only use your data to 
                provide our Services.
              </p>
              <p className="text-gray-300 mb-4">
                <strong>Deliverables:</strong> Upon full payment, you own all custom code, configurations, 
                and documentation created specifically for your project.
              </p>
              <p className="text-gray-300">
                <strong>Our IP:</strong> We retain ownership of our pre-existing tools, frameworks, methodologies, 
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">7. Service Level Agreement (SLA)</h2>
              <div className="space-y-3">
                <div className="flex items-start">
                  <HiCheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5" />
                  <span className="text-gray-300">
                    <strong>Response Time:</strong> Initial response within 24 business hours
                  </span>
                </div>
                <div className="flex items-start">
                  <HiCheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5" />
                  <span className="text-gray-300">
                    <strong>Uptime:</strong> 99.9% uptime for managed services (excluding scheduled maintenance)
                  </span>
                </div>
                <div className="flex items-start">
                  <HiCheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5" />
                ...
                <div className="flex items-start">
                  <HiCheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5" />
                  <span className="text-gray-300">
                    <strong>Emergency Support:</strong> Available for critical issues (additional fees may apply)
                  </span>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-4">
                <strong>Our Warranty:</strong> We warrant that our Services will be performed in a professional 
                and workmanlike manner consistent with industry standards.
              </p>
              <p className="text-gray-300">
                <strong>Disclaimer:</strong> Services are provided "as is" without warranty of any kind, either 
            ...
            <section>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700">
                ...
                <div className="space-y-2 text-gray-300">
                  <p><strong>Tag Specialist</strong></p>
