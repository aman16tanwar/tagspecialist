        ...
        <div className="bg-white rounded-lg p-8 md:p-12 border border-gray-200 shadow-sm">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Last updated: January 18, 2025</p>
            </div>
          </div>

          <div className="prose prose-slate max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-navy-900 mb-4">Our Commitment to Your Privacy</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                <HiLockClosed className="w-6 h-6 mr-2 text-green-600" />
                Information We Collect
              </h2>
              
              <h3 className="text-xl font-semibold text-navy-900 mb-2">Information You Provide</h3>
              ...
              <h3 className="text-xl font-semibold text-navy-900 mb-2">Information Automatically Collected</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-navy-900 mb-4">Data Security Measures</h2>
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <HiShieldCheck className="w-5 h-5 text-green-600 mr-2 mt-0.5" />
                    <span className="text-gray-700">SSL/TLS encryption for all data transmissions</span>
                  </li>
                  <li className="flex items-start">
                    <HiShieldCheck className="w-5 h-5 text-green-600 mr-2 mt-0.5" />
                  ...
                  <li className="flex items-start">
                    <HiShieldCheck className="w-5 h-5 text-green-600 mr-2 mt-0.5" />
                    <span className="text-gray-700">GDPR and CCPA compliant practices</span>
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li><strong className="text-navy-900">Access:</strong> Request a copy of your personal data</li>
                <li><strong className="text-navy-900">Correction:</strong> Request correction of inaccurate data</li>
                <li><strong className="text-navy-900">Deletion:</strong> Request deletion of your personal data</li>
                <li><strong className="text-navy-900">Portability:</strong> Receive your data in a structured format</li>
                <li><strong className="text-navy-900">Objection:</strong> Object to certain processing activities</li>
                <li><strong className="text-navy-900">Withdrawal:</strong> Withdraw consent at any time</li>
              </ul>
            </section>
